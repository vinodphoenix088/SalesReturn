...
namespace SalesReturnDAL.DBContext
{
    ...
    public partial class tblRequestDtl
    {
        ...
        public Nullable<int> ExccessQTY { get; set; }
        public Nullable<int> DamagedQTY { get; set; }
        public Nullable<int> ReasonforSAP { get; set; }
        public Nullable<bool> Acknowledge { get; set; }
        public string DONo { get; set; }
        public string SRVInvoiceNo { get; set; }
        public Nullable<System.DateTime> MaterialRcvDate { get; set; }
